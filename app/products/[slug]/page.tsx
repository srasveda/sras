    ...
    <>
      <section className="section bg-card">
        <div className="container grid gap-10 md:grid-cols-2 md:items-center">
          <div
            className={`relative aspect-[4/3] overflow-hidden rounded-2xl border border-border ${product.tone}`}
          >
            <Image
              src={product.image}
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild variant="outline" size="lg">
                <a
                  href={whatsappUrl(
                    `Hi, I want to order ${product.name} via WhatsApp.`
                  )}
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="container">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            {[
              {
                icon: ShieldCheck,
                title: 'Founded in 1998',
                copy: '25+ years of Ayurvedic heritage and expertise.',
              },
              {
                icon: PackageCheck,
                title: 'Secure packaging',
                copy: 'Packed carefully for a premium doorstep experience.',
              },
              {
                icon: ShieldCheck,
                title: 'Consultation led',
                copy: 'Guidance first, purchase second.',
              },
            ].map((item) => (
              <div
                key={item.title}
