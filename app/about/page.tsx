      ...
      <section className="section bg-[#ebe1cf]">
        <div className="container grid gap-5 md:grid-cols-3">
          {[
            [
              'Heritage',
              "Traditional Ayurvedic positioning informs the brand's approach to wellness categories.",
            ],
            [
              'Modern care',
              'Clean product education, mobile-first browsing, and WhatsApp consultation make purchase decisions easier.',
            ],
            [
              'Responsible commerce',
              'No complex checkout or rushed cart flow. Customers can ask questions before ordering.',
            ],
          ].map(([title, copy]) => (
            <div
              key={title}
