  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-background/92 backdrop-blur">
      <div className="container flex h-16 items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-3" aria-label="SRAS Veda home">
          ...
          <span>
            <span className="block font-serif text-xl font-bold leading-5">{brand.name}</span>
            <span className="block text-[11px] font-medium text-muted-foreground">By Shri Ram Ayurvedshala</span>
          </span>
        </Link>
